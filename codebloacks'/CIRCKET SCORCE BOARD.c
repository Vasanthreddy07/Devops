...
char name[25];
int runs,score,balls,toruns,tobal,ones,twos,threes,fours,sixes; int max_six,max_run,max_four;
float str;
...
char name[25]; int runsgv,wkttkn,overs; int max_w;
...
(4*pl1[plno].fours)+(6*pl1[plno].sixes); pl1[plno].str=(pl1[plno].runs*100.00)/pl1[plno].balls;

printf(" %-15s %-14d %-13d %-11d %-11d %9.2f\n\n",pl1[plno].name,
 pl1[plno].runs,pl1[plno].balls,pl1[plno].fours,pl1[plno].sixes, pl1[plno].str);
break; case 2: printf("Enter the bowlers number to see his details\n"); scanf("%d",&plno);
plno--;
...
for(i=0;i<n;i++)
{ pl2[i].econ=pl2[i].runsgv/pl2[i].overs; printf(" %-15s %-14d %-13d %-11d %11.2f\n\n\n",
...
case 4: pl3.max_run=0,pl4.max_w=0,pl3.max_four=0,pl3.max_six=0; for(i=0;i<m;i++)
{
