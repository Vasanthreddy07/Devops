...
int main() {
    int plno, choice;
    int i, n, m, k;
    printf("Enter the no. of players in both teams (should be 11 or less): ");
    scanf("%d", &k);
    ...
    if (k <= 11) {
        ...
        for (i = 0; i < m; i++) {
            ...
            printf("Enter the number of ones scored by player%d: ", i + 1);
            scanf("%d", &pl1[i].ones);

            printf("Enter the number of twos scored by player%d: ", i + 1);
            scanf("%d", &pl1[i].twos);

            printf("Enter the number of threes scored by player%d: ", i + 1);
            scanf("%d", &pl1[i].threes);

            printf("Enter the number of fours scored by player%d: ", i + 1);
            scanf("%d", &pl1[i].fours);

            printf("Enter the number of sixes scored by player%d: ", i + 1);
            scanf("%d", &pl1[i].sixes);

            printf("Enter the balls played by the player%d: ", i + 1);
            scanf("%d", &pl1[i].balls);
        }
        ...
        printf("Number of players should be 11 or less.\n");
    }
    return 0;
}
